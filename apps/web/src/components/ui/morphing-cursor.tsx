...
export function MagneticText({
  ...
  return (
    ...
    >
      ...
      <span className={cn("font-bold tracking-tight text-ink-muted", textClassName)}>{text}</span>

      <div
        ref={circleRef}
        className={cn(
          "absolute top-0 left-0 pointer-events-none rounded-full overflow-hidden shadow-[0_0_25px_rgba(240,180,41,0.5)]",
          circleBgClass
        )}
        style={{
      ...
      >
        ...
        >
          <span className={cn("font-extrabold tracking-tight whitespace-nowrap leading-none", textClassName, circleTextClass)}>
            {hoverText || text}
          </span>
        </div>
      </div>
