...
export const BorderGlow: React.FC<BorderGlowProps> = ({
  ...
  edgeSensitivity = 30,
  glowColor = "40 80 80",
  backgroundColor = "var(--color-surface-1, #141517)",
  borderRadius = 28,
  glowRadius = 40,
  glowIntensity = 1.0,
  coneSpread = 25,
